...
//			{0x22,0x66,0xaa,0xee},{0x33,0x77,0xbb,0xff}};
	...
	public static int[][] M = {{2,3,1,1},{1,2,3,1},{1,1,2,3},{3,0,1,2}};
...
//	}
	...
	public int[][] matrixMult_EX(int[][] a, int[][]b){
		if(a.length != b[0].length) return null;
...
//				System.out.print((originalKey[j][i] >= 16) ? (Integer.toHexString(originalKey[j][i]) + " "): ("0".concat(Integer.toHexString(originalKey[j][i]) + " ")));
//			}
//		}
//		System.out.println();
//		System.out.println("-----------------------------------------------------------");
...
//				System.out.print((keyTest[j][i] >= 16) ? (Integer.toHexString(keyTest[j][i]) + " "): ("0".concat(Integer.toHexString(keyTest[j][i]) + " ")));
//			}
//		}
//		System.out.println();
//	}
